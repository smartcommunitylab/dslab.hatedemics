...
export default {
  ...
  mounted: function () {
    ...
    if (this.annotationID) {
      promises.push(API.dialogs.getAnnotation(this.projectID, this.taskID, this.annotationID))
    } else if (this.annotationParent) {
      promises.push(API.dialogs.getAnnotation(this.projectID, this.taskID, this.annotationParent))
    }
