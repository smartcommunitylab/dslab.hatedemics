...
<template>
  <v-container class="py-10">
    ...
    <v-row justify="center" align="stretch" class="mt-4" dense>
      ...
      <v-col cols="12" md="5">
        <v-card elevation="6" class="h-100 pa-5 d-flex flex-column justify-space-between" color="#f9f4f4">
          <div>
            <div class="d-flex align-center mb-2">
              <v-icon color="secondary" class="mr-2">mdi-message-text-outline</v-icon>
          ...
          <div class="text-right mt-6">
            <v-btn color="secondary" to="/projects" variant="flat">
